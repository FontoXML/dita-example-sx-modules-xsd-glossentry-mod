define([
	...
	return function configureSxModule (sxModule) {
		...
		configureAsSheetFrame(sxModule, 'self::glossentry', t('entry'), {
			titleQuery: './glossterm//text()[not(ancestor::*[name() = ("sort-at", "draft-comment", "foreign", "unknown", "required-cleanup", "image")])]/string() => string-join()',
			blockFooter: [
		...
		configureAsFrame(sxModule, 'self::glossentry[parent::*[fonto:dita-class(., "topic/topic")]]', undefined, {
			contextualOperations: [
